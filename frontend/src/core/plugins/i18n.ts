...
const messages = {
  ...
  tr: {
    dashboard: "Başlangıç",
    layoutBuilder: "Yapı Kurucu",
    craft: "Crafted",
    pages: "Sayfalar",
    profile: "Profil",
    profileOverview: "Onizleme",
    projects: "Projeler",
    ...
    docsAndComponents: "Dökümanlar & Komponentler",
    megaMenu: "Mega Menü",
    exampleLink: "Örnek link",
    modals: "Modallar",
    general: "Genel",
    inviteFriends: "Arkadaşlarını Davet et",
    viewUsers: "Kullanıcıları Göster",
    upgradePlan: "Hesabı Yükseltin",
    shareAndEarn: "Paylaş & Kazan",
    forms: "Formlar",
    newTarget: "Yeni Hedef",
    newCard: "Yeni Kart",
    newAddress: "Yeni Adres",
    createAPIKey: "API Anahtarı Oluştur",
    twoFactorAuth: "İki Faktörlü Yetki",
    ...
    calendarApp: "Takvim",
    subscriptions: "Takipçiler",
    getStarted: "Başlarken",
    subscriptionList: "Takipçi Listesi",
    addSubscription: "Takipçi Ekle",
    viewSubscription: "Takipçi Görüntüle",
  },
};
