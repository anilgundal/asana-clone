  ...
  <div class="w-lg-500px bg-white rounded shadow-sm p-10 p-lg-15 mx-auto">
    ...
    >
      ...
      <div class="text-center mb-10">
        <!--begin::Title-->
        <h1 class="text-dark mb-3">Panel Giriş Ekranı</h1>
        <!--end::Title-->
      ...
      <div class="fv-row mb-10">
        <!--begin::Label-->
        <label class="form-label fs-6 fw-bolder text-dark">Eposta</label>
        <!--end::Label-->
...
export default defineComponent({
  ...
  setup() {
    ...
    const onSubmitLogin = async (values) => {
      ...
      if (!error) {
        Swal.fire({
          text: "Başlangıç sayfasına yönlendiriliyorsunuz!",
          icon: "success",
